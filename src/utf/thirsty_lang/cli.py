...
'''
        ...
        if file_path.endswith('.thirstofgods'):
            from src.utf.thirst_of_gods.cli import run as gods_run
            gods_run(file_path)
            return
...
def cmd_new(args):
    ...
    from src.utf.thirsty_lang.package_manager import create_thirsty_toml, create_thirsty_lock
...
def _transpile_to_js(ast) -> str:
    ...
    from src.utf.thirsty_lang.formatter import format_expr, format_stmt
